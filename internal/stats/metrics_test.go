...
func TestServeMetricsEndpoint(t *testing.T) {
	...
	m := New()
	m.ClientConnsTotal.Inc()
	m.QueriesTotal.WithLabelValues("appdb", "alice", "myapp").Add(7)
	...
	require.Contains(t, body, `pgrouter_queries_total{application_name="myapp",database="appdb",user="alice"} 7`)
